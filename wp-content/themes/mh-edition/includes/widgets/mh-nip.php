...
class mh_edition_nip extends WP_Widget {
    function __construct() {
		parent::__construct(
			'mh_edition_nip', esc_html_x('MH News in Pictures', 'widget name', 'mh-edition'),
			array(
				'classname' => 'mh_edition_nip',
				'description' => esc_html__('MH News in Pictures widget to display a gallery of thumbnails linked to the post content.', 'mh-edition'),
				...
				while ($nip_loop->have_posts()) : $nip_loop->the_post(); ?>
					<li class="mh-nip-item">
						<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>">
							<?php the_post_thumbnail('mh-edition-small'); ?>
