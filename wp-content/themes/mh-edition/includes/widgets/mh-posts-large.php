...
class mh_edition_posts_large extends WP_Widget {
	function __construct() {
		parent::__construct(
			'mh_edition_posts_large', esc_html_x('MH Posts Large', 'widget name', 'mh-edition'),
			array(
				'classname' => 'mh_edition_posts_large',
				'description' => esc_html__('MH Posts Large widget to display posts (large-sized) including thumbnail images.', 'mh-edition'),
