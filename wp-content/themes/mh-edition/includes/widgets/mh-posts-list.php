...
class mh_edition_posts_list extends WP_Widget {
	function __construct() {
		parent::__construct(
			'mh_edition_posts_list', esc_html_x('MH Posts List', 'widget name', 'mh-edition'),
			array(
				'classname' => 'mh_edition_posts_list',
				'description' => esc_html__('MH Posts List widget to display a list of posts with thumbnails.', 'mh-edition'),
