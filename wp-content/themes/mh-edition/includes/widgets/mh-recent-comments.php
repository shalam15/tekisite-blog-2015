...
class mh_edition_recent_comments extends WP_Widget {
    function __construct() {
		parent::__construct(
			'mh_edition_recent_comments', esc_html_x('MH Recent Comments', 'widget name', 'mh-edition'),
			array(
				'classname' => 'mh_edition_recent_comments',
				'description' => esc_html__('MH Recent Comments widget to display your recent comments including user avatars.', 'mh-edition'),
						...
						<li class="mh-user-item clearfix"><?php
							...
							<div class="mh-user-meta">
								<span class="mh-recent-comments-author">
									<?php printf(_x('%1$s on %2$s', 'comment widget', 'mh-edition'), esc_attr($comment->comment_author), ''); ?>
								</span>
    ...
    function form($instance) {
    	$defaults = array('title' => esc_html__('Recent Comments', 'mh-edition'), 'number' => 5, 'offset' => 0, 'avatar_size' => 48);
		$instance = wp_parse_args($instance, $defaults); ?>
		<p>
		...
		<p>
        	<label for="<?php echo esc_attr($this->get_field_id('number')); ?>"><?php esc_html_e('Limit Comment Number:', 'mh-edition'); ?></label>
		...
		<p>
        	<label for="<?php echo esc_attr($this->get_field_id('offset')); ?>"><?php esc_html_e('Skip Comments (Offset):', 'mh-edition'); ?></label>
