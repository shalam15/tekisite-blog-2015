...
class mh_edition_youtube extends WP_Widget {
    function __construct() {
		parent::__construct(
			'mh_edition_youtube', esc_html_x('MH YouTube Video', 'widget name', 'mh-edition'),
			array(
				'classname' => 'mh_edition_youtube',
				'description' => esc_html__('MH YouTube Video widget to display a YouTube Video.', 'mh-edition'),
    ...
    function form($instance) {
        ...
        <p>
        	<label for="<?php echo esc_attr($this->get_field_id('video_id')); ?>"><?php esc_html_e('Video ID:', 'mh-edition'); ?></label>
            ...
            <small><?php _e('Enter the YouTube video ID - also known as the watch code (e.g. AvOTBFM_3RQ)', 'mh-edition'); ?></small>
        </p>
        <p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('autoplay')); ?>"><?php esc_html_e('Enable Autoplay', 'mh-edition'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('showinfo')); ?>"><?php esc_html_e('Display Video Title / Information', 'mh-edition'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('controls')); ?>"><?php esc_html_e('Display Player Controls', 'mh-edition'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('related')); ?>"><?php esc_html_e('Recommend Related Videos', 'mh-edition'); ?></label>
		</p><?php
    }
}
