...
class mh_cicero_youtube extends WP_Widget {
    function __construct() {
		parent::__construct(
			'mh_cicero_youtube', esc_html_x('MH YouTube Video', 'widget name', 'mh-cicero'),
			array(
				'classname' => 'mh_cicero_youtube',
				'description' => esc_html__('Widget to display a YouTube Video.', 'mh-cicero'),
    ...
    function form($instance) {
        ...
        <p>
        	<label for="<?php echo esc_attr($this->get_field_id('link')); ?>"><?php esc_html_e('Link Title to custom URL (optional):', 'mh-cicero'); ?></label>
        ...
        <p>
        	<label for="<?php echo esc_attr($this->get_field_id('video_id')); ?>"><?php esc_html_e('Video ID:', 'mh-cicero'); ?></label>
            ...
            <small><?php _e('Enter the YouTube video ID - also known as the watch code, example: AvOTBFM_3RQ)', 'mh-cicero'); ?></small>
        </p>
        <p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('autoplay')); ?>"><?php esc_html_e('Enable Autoplay', 'mh-cicero'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('showinfo')); ?>"><?php esc_html_e('Display Video Title / Information', 'mh-cicero'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('controls')); ?>"><?php esc_html_e('Display Player Controls', 'mh-cicero'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('related')); ?>"><?php esc_html_e('Recommend Related Videos', 'mh-cicero'); ?></label>
		</p><?php
    }
}
