...
class mh_carousel_hp_widget extends WP_Widget {
    function __construct() {
		parent::__construct(
			'mh_carousel_hp', esc_html_x('MH Carousel (Homepage)', 'widget name', 'mhc'),
			array(
				'classname' => 'mh_carousel_hp',
				'description' => esc_html__('Carousel widget for use on homepage template.', 'mhc')
			)
		);
	}
    function widget($args, $instance) {
	    $defaults = array('title' => '', 'category' => 0, 'cats' => '', 'tags' => '', 'postcount' => 10, 'offset' => 0, 'order' => 'date', 'sticky' => 1);
		...
		echo $args['before_widget'];
			...
			<div id="mh-carousel-<?php echo rand(1, 9999); ?>" class="flexslider">
	        	<ul class="slides"><?php
						...
						<li class="carousel-item">
							<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php
								if (has_post_thumbnail()) {
									...
									echo '<img class="mh-image-placeholder" src="' . get_template_directory_uri() . '/images/noimage_174x98.png' . '" alt="No Picture" />';
								} ?>
							</a>
							<div class="caption">
