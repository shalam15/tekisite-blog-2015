...
class mh_custom_slider_widget extends WP_Widget {
    function __construct() {
		parent::__construct(
			'mh_custom_slider', esc_html_x('MH Custom Slider', 'widget name', 'mhc'),
			array(
				'classname' => 'mh_custom_slider',
				'description' => esc_html__('Custom Slider Widget to display custom content for use on homepage template.', 'mhc')
			)
		);
	}
    function widget($args, $instance) {
		$options = mh_theme_options();
    	$default_Image = esc_url(get_template_directory_uri() . '/images/noimage_940x400.png');
									...
									<?php if ($slide['title'] || $slide['excerpt']) { ?>
										<div class="slide-caption">
											<div class="slide-data">
												<?php if ($slide['title']) { ?>
													<a href="<?php echo esc_url($slide['url']); ?>" title="<?php echo esc_attr($slide['title']); ?>">
												...
												<?php if ($slide['excerpt']) { ?>
													<div class="slide-excerpt mh-excerpt">
														...
														<a href="<?php echo esc_url($slide['url']); ?>" title="<?php echo esc_attr($slide['title']); ?>">
															<?php echo esc_attr($excerpt_more); ?>
														</a>
													</div>
												<?php } ?>
											</div>
    ...
    function update($new_instance, $old_instance) {
		...
		if (!empty($new_instance['excerpt1'])) {
			$instance['excerpt1'] = mh_corporate_sanitize_text($new_instance['excerpt1']);
		}
		...
		if (!empty($new_instance['excerpt2'])) {
			$instance['excerpt2'] = mh_corporate_sanitize_text($new_instance['excerpt2']);
		}
		...
		if (!empty($new_instance['excerpt3'])) {
			$instance['excerpt3'] = mh_corporate_sanitize_text($new_instance['excerpt3']);
		}
		...
		if (!empty($new_instance['excerpt4'])) {
			$instance['excerpt4'] = mh_corporate_sanitize_text($new_instance['excerpt4']);
		}
		...
		if (!empty($new_instance['excerpt5'])) {
			$instance['excerpt5'] = mh_corporate_sanitize_text($new_instance['excerpt5']);
		}
	...
	function form($instance) {
        ...
        $instance = wp_parse_args($instance, $defaults); ?>
        <p class="widget-separator"><?php printf(esc_html('Slide %d:', 'mhc'), 1); ?></p>
        <p>
        	<label for="<?php echo esc_attr($this->get_field_id('title1')); ?>"><?php esc_html_e('Title:', 'mhc'); ?></label>
	    ...
	    <p>
        	<label for="<?php echo esc_attr($this->get_field_id('url1')); ?>"><?php esc_html_e('Custom URL:', 'mhc'); ?></label>
	    ...
	    <p>
        	<label for="<?php echo esc_attr($this->get_field_id('image1')); ?>"><?php esc_html_e('Custom Image URL:', 'mhc'); ?></label>
	    ...
	    <p>
	    	<label for="<?php echo esc_attr($this->get_field_id('excerpt1')); ?>"><?php esc_html_e('Custom Excerpt:', 'mhc'); ?></label>
	    	<textarea cols="60" rows="3" style="width: 100%;" placeholder="<?php esc_html_e('Enter Custom Excerpt', 'mhc') ?>" name="<?php echo esc_attr($this->get_field_name('excerpt1')); ?>" id="<?php echo esc_attr($this->get_field_id('excerpt1')); ?>"><?php echo esc_attr($instance['excerpt1']); ?></textarea>
	    </p>
	    <p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('target1')); ?>"><?php esc_html_e('Open Links in new Window / Tab', 'mhc'); ?></label>
    	</p>
    	<p class="widget-separator"><?php printf(esc_html('Slide %d:', 'mhc'), 2); ?></p>
        <p>
        	<label for="<?php echo esc_attr($this->get_field_id('title2')); ?>"><?php esc_html_e('Title:', 'mhc'); ?></label>
	    ...
	    <p>
        	<label for="<?php echo esc_attr($this->get_field_id('url2')); ?>"><?php esc_html_e('Custom URL:', 'mhc'); ?></label>
	    ...
	    <p>
        	<label for="<?php echo esc_attr($this->get_field_id('image2')); ?>"><?php esc_html_e('Custom Image URL:', 'mhc'); ?></label>
	    ...
	    <p>
	    	<label for="<?php echo esc_attr($this->get_field_id('excerpt2')); ?>"><?php esc_html_e('Custom Excerpt:', 'mhc'); ?></label>
	    	<textarea cols="60" rows="3" style="width: 100%;" placeholder="<?php esc_html_e('Enter Custom Excerpt', 'mhc') ?>" name="<?php echo esc_attr($this->get_field_name('excerpt2')); ?>" id="<?php echo esc_attr($this->get_field_id('excerpt2')); ?>"><?php echo esc_attr($instance['excerpt2']); ?></textarea>
	    </p>
	    <p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('target2')); ?>"><?php esc_html_e('Open Links in new Window / Tab', 'mhc'); ?></label>
    	</p>
    	<p class="widget-separator"><?php printf(esc_html('Slide %d:', 'mhc'), 3); ?></p>
        <p>
        	<label for="<?php echo esc_attr($this->get_field_id('title3')); ?>"><?php esc_html_e('Title:', 'mhc'); ?></label>
	    ...
	    <p>
        	<label for="<?php echo esc_attr($this->get_field_id('url3')); ?>"><?php esc_html_e('Custom URL:', 'mhc'); ?></label>
	    ...
	    <p>
        	<label for="<?php echo esc_attr($this->get_field_id('image3')); ?>"><?php esc_html_e('Custom Image URL:', 'mhc'); ?></label>
	    ...
	    <p>
	    	<label for="<?php echo esc_attr($this->get_field_id('excerpt3')); ?>"><?php esc_html_e('Custom Excerpt:', 'mhc'); ?></label>
	    	<textarea cols="60" rows="3" style="width: 100%;" placeholder="<?php esc_html_e('Enter Custom Excerpt', 'mhc') ?>" name="<?php echo esc_attr($this->get_field_name('excerpt3')); ?>" id="<?php echo esc_attr($this->get_field_id('excerpt3')); ?>"><?php echo esc_attr($instance['excerpt3']); ?></textarea>
	    </p>
	    <p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('target3')); ?>"><?php esc_html_e('Open Links in new Window / Tab', 'mhc'); ?></label>
    	</p>
    	<p class="widget-separator"><?php printf(esc_html('Slide %d:', 'mhc'), 4); ?></p>
        <p>
        	<label for="<?php echo esc_attr($this->get_field_id('title4')); ?>"><?php esc_html_e('Title:', 'mhc'); ?></label>
	    ...
	    <p>
        	<label for="<?php echo esc_attr($this->get_field_id('url4')); ?>"><?php esc_html_e('Custom URL:', 'mhc'); ?></label>
	    ...
	    <p>
        	<label for="<?php echo esc_attr($this->get_field_id('image4')); ?>"><?php esc_html_e('Custom Image URL:', 'mhc'); ?></label>
	    ...
	    <p>
	    	<label for="<?php echo esc_attr($this->get_field_id('excerpt4')); ?>"><?php esc_html_e('Custom Excerpt:', 'mhc'); ?></label>
	    	<textarea cols="60" rows="3" style="width: 100%;" placeholder="<?php esc_html_e('Enter Custom Excerpt', 'mhc') ?>" name="<?php echo esc_attr($this->get_field_name('excerpt4')); ?>" id="<?php echo esc_attr($this->get_field_id('excerpt4')); ?>"><?php echo esc_attr($instance['excerpt4']); ?></textarea>
	    </p>
	    <p>
	  		...
	  		<label for="<?php echo esc_attr($this->get_field_id('target4')); ?>"><?php esc_html_e('Open Links in new Window / Tab', 'mhc'); ?></label>
    	</p>
    	<p class="widget-separator"><?php printf(esc_html('Slide %d:', 'mhc'), 5); ?></p>
        <p>
        	<label for="<?php echo esc_attr($this->get_field_id('title5')); ?>"><?php esc_html_e('Title:', 'mhc'); ?></label>
	    ...
	    <p>
        	<label for="<?php echo esc_attr($this->get_field_id('url5')); ?>"><?php esc_html_e('Custom URL:', 'mhc'); ?></label>
	    ...
	    <p>
        	<label for="<?php echo esc_attr($this->get_field_id('image5')); ?>"><?php esc_html_e('Custom Image URL:', 'mhc'); ?></label>
	    ...
	    <p>
	    	<label for="<?php echo esc_attr($this->get_field_id('excerpt5')); ?>"><?php esc_html_e('Custom Excerpt:', 'mhc'); ?></label>
	    	<textarea cols="60" rows="3" style="width: 100%;" placeholder="<?php esc_html_e('Enter Custom Excerpt', 'mhc') ?>" name="<?php echo esc_attr($this->get_field_name('excerpt5')); ?>" id="<?php echo esc_attr($this->get_field_id('excerpt5')); ?>"><?php echo esc_attr($instance['excerpt5']); ?></textarea>
	    </p>
	    <p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('target5')); ?>"><?php esc_html_e('Open Links in new Window / Tab', 'mhc'); ?></label>
    	</p><?php
    }
}
