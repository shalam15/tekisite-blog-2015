...
class mh_nip_widget extends WP_Widget {
    function __construct() {
		parent::__construct(
			'mh_nip', esc_html_x('MH News in Pictures', 'widget name', 'mhc'),
			array(
				'classname' => 'mh_nip',
				'description' => esc_html__('MH News in Pictures Widget to display a gallery of thumbnails linked to the post content.', 'mhc'),
				...
				while ($nip_loop->have_posts()) : $nip_loop->the_post(); ?>
					<li class="nip-thumb">
						<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>">
							<?php the_post_thumbnail('cp_small'); ?>
						</a>
					</li><?php
				endwhile;
				wp_reset_postdata(); ?>
