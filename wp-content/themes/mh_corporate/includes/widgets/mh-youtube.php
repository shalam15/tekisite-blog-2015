...
class mh_corporate_youtube extends WP_Widget {
    function __construct() {
		parent::__construct(
			'mh_corporate_youtube', esc_html_x('MH YouTube Video', 'widget name', 'mhc'),
			array(
				'classname' => 'mh_corporate_youtube',
				'description' => esc_html__('Widget to display a YouTube Video.', 'mhc'),
    ...
    function form($instance) {
        ...
        <p>
        	<label for="<?php echo esc_attr($this->get_field_id('video_id')); ?>"><?php esc_html_e('Video ID:', 'mhc'); ?></label>
            ...
            <small><?php _e('Enter the YouTube video ID - also known as the watch code (e.g. AvOTBFM_3RQ)', 'mhc'); ?></small>
        </p>
        <p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('autoplay')); ?>"><?php esc_html_e('Enable Autoplay', 'mhc'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('showinfo')); ?>"><?php esc_html_e('Display Video Title / Information', 'mhc'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('controls')); ?>"><?php esc_html_e('Display Player Controls', 'mhc'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('related')); ?>"><?php esc_html_e('Recommend Related Videos', 'mhc'); ?></label>
		</p><?php
    }
}
