...
class mh_elegance_comments_widget extends WP_Widget {
    function __construct() {
		parent::__construct(
			'mh_elegance_comments_widget', esc_html_x('MH Recent Comments', 'widget name', 'mh-elegance'),
			array(
				'classname' => 'mh_elegance_comments_widget',
				'description' => esc_html__('MH Recent Comments widget to display your recent comments including user avatars.', 'mh-elegance'),
						...
						<li class="uw-wrap clearfix">
							...
							<div class="uw-text">
								<span class="mh-recent-comments-author">
									<?php printf(esc_html_x('%1$s on %2$s', 'comment widget', 'mh-elegance'), $comment->comment_author, ''); ?>
								</span>
    ...
    function form($instance) {
	    $defaults = array('title' => esc_html__('Recent Comments', 'mh-elegance'), 'number' => 5, 'offset' => 0, 'avatar_size' => 48);
		$instance = wp_parse_args($instance, $defaults); ?>
		<p>
		...
		<p>
        	<label for="<?php echo esc_attr($this->get_field_id('number')); ?>"><?php esc_html_e('Limit Comment Number:', 'mh-elegance'); ?></label>
		...
		<p>
        	<label for="<?php echo esc_attr($this->get_field_id('offset')); ?>"><?php esc_html_e('Skip Comments (Offset):', 'mh-elegance'); ?></label>
