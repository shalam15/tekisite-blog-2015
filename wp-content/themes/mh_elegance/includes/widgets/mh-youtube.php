...
class mh_elegance_youtube extends WP_Widget {
    function __construct() {
		parent::__construct(
			'mh_elegance_youtube', esc_html_x('MH YouTube Video', 'widget name', 'mh-elegance'),
			array(
				'classname' => 'mh_elegance_youtube',
				'description' => esc_html__('Widget to display a YouTube Video.', 'mh-elegance'),
    ...
    function form($instance) {
        ...
        <p>
        	<label for="<?php echo esc_attr($this->get_field_id('video_id')); ?>"><?php esc_html_e('Video ID:', 'mh-elegance'); ?></label>
            ...
            <small><?php _e('Enter the YouTube video ID - also known as the watch code, example: AvOTBFM_3RQ)', 'mh-elegance'); ?></small>
        </p>
        <p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('autoplay')); ?>"><?php esc_html_e('Enable Autoplay', 'mh-elegance'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('showinfo')); ?>"><?php esc_html_e('Display Video Title / Information', 'mh-elegance'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('controls')); ?>"><?php esc_html_e('Display Player Controls', 'mh-elegance'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('related')); ?>"><?php esc_html_e('Recommend Related Videos', 'mh-elegance'); ?></label>
		</p><?php
    }
}
?>