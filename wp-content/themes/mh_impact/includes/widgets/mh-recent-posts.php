...
class mh_impact_recent_posts extends WP_Widget {
    function __construct() {
		parent::__construct(
			'mh_impact_recent_posts', esc_html_x('MH Recent Posts', 'widget name', 'mh-impact'),
			array(
				'classname' => 'mh_impact_recent_posts',
				'description' => esc_html__('Display a list of most recent posts.', 'mh-impact'),
