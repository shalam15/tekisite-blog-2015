...
class mh_joystick_posts_large extends WP_Widget {
	function __construct() {
		parent::__construct(
			'mh_joystick_posts_large', esc_html_x('MH Posts Large', 'widget name', 'mh-joystick'),
			array(
				'classname' => 'mh_joystick_posts_large',
				'description' => esc_html__('Display posts (large-sized) including thumbnail images.', 'mh-joystick'),
