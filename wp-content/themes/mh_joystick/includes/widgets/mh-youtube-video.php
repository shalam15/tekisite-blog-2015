...
class mh_joystick_youtube_video extends WP_Widget {
    function __construct() {
		parent::__construct(
			'mh_joystick_youtube_video', esc_html_x('MH YouTube Video', 'widget name', 'mh-joystick'),
			array(
				'classname' => 'mh_joystick_youtube_video',
				'description' => esc_html__('Widget to display a YouTube Video.', 'mh-joystick'),
    ...
    function form($instance) {
        ...
        <p>
        	<label for="<?php echo esc_attr($this->get_field_id('video_id')); ?>"><?php esc_html_e('Video ID:', 'mh-joystick'); ?></label>
            ...
            <small><?php _e('Enter the YouTube video ID - also known as the watch code (e.g. AvOTBFM_3RQ)', 'mh-joystick'); ?></small>
        </p>
        <p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('autoplay')); ?>"><?php esc_html_e('Enable Autoplay', 'mh-joystick'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('showinfo')); ?>"><?php esc_html_e('Display Video Title / Information', 'mh-joystick'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('controls')); ?>"><?php esc_html_e('Display Player Controls', 'mh-joystick'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('related')); ?>"><?php esc_html_e('Recommend Related Videos', 'mh-joystick'); ?></label>
		</p><?php
    }
}
