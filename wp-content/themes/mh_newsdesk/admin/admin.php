		...
		<div class="theme-info-wrap">
			...
			<div class="theme-links clearfix">
				<p><strong><?php _e('Important Links:', 'mh-newsdesk'); ?></strong>
					<a href="<?php echo esc_url('https://www.mhthemes.com/themes/mh/newsdesk/'); ?>" target="_blank"><?php _e('Theme Info Page', 'mh-newsdesk'); ?></a>
					<a href="<?php echo esc_url('https://www.mhthemes.com/support/'); ?>" target="_blank"><?php _e('Support Center', 'mh-newsdesk'); ?></a>
				...
				<div class="row clearfix">
					<div class="col-1-2">
						<div class="section">
							...
							<p>
								<a href="<?php echo esc_url('https://www.mhthemes.com/support/documentation-mh-newsdesk/'); ?>" target="_blank" class="button button-secondary"><?php _e('Visit Documentation', 'mh-newsdesk'); ?></a>
							</p>
						</div>
						<div class="section">
						...
						<div class="section">
							...
							<p>
								<a href="<?php echo esc_url('https://www.mhthemes.com/members/login/'); ?>" target="_blank" class="button button-secondary"><?php _e('Login to MH Themes account', 'mh-newsdesk'); ?></a>
							</p>
						</div>
					</div>
					<div class="col-1-2">
			...
			<hr>
			<div id="theme-author">
				<p><?php printf(__('%1s WordPress theme is proudly brought to you by %2s.', 'mh-newsdesk'), $theme_data->Name, '<a target="_blank" href="https://www.mhthemes.com/" title="MH Themes">MH Themes</a>'); ?></p>
			</div>
		</div> <?php
	}
}
...
if (!function_exists('mh_newsdesk_admin_notice')) {
	function mh_newsdesk_admin_notice() {
		global $pagenow;
		if (current_user_can('edit_theme_options') && $pagenow == 'index.php') {
    		$theme_data = wp_get_theme(); ?>
			<div class="updated">
        		<p><?php printf(__('Thanks for using %1s by MH Themes. To learn more about this theme, please %1s.', 'mh-newsdesk'), '<strong>' . $theme_data->Name . ' WordPress Theme</strong>', '<a href="' . admin_url('themes.php?page=newsdesk') . '"><strong>' . __('click here', 'mh-newsdesk') . '</strong></a>'); ?></p>
			</div><?php
		}
	}
}
add_action('admin_notices', 'mh_newsdesk_admin_notice');
