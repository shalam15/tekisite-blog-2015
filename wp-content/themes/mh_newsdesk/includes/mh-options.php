...
function mh_newsdesk_custom_css() {
	...
	<style type="text/css">
    	...
    	<?php if ($mh_newsdesk_options['color_6'] != '#ffffff') { ?>
			.header-nav li a, .main-nav li a, .footer-nav li a, .social-nav .fa-mh-social, .mh-footer, .mh-footer a, .mh-footer .wp-caption-text, .footer-widgets .widget-title { color: <?php echo $mh_newsdesk_options['color_6']; ?>; }
    	<?php } ?>
	</style>
    <?php
	endif;
