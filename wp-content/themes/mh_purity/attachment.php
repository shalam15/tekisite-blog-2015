		...
		<article <?php post_class(); ?>>
			...
			<div class="entry clearfix"> <?php
				if (wp_attachment_is_image($post->id)) {
					...
					<a href="<?php echo wp_get_attachment_url($post->id); ?>" title="<?php echo get_the_title(); ?>" rel="attachment" target="_blank"><img src="<?php echo $att_image[0]; ?>" width="<?php echo $att_image[1]; ?>" height="<?php echo $att_image[2]; ?>" class="mh-attachment attachment-medium" alt="<?php echo get_the_title(); ?>" /></a>
