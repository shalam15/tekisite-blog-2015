...
class mh_purity_facebook_page extends WP_Widget {
	function __construct() {
		parent::__construct(
			'mh_purity_facebook_page', esc_html_x('MH Facebook Page', 'widget name', 'mhp'),
			array(
				'classname' => 'mh_purity_facebook_page',
				'description' => esc_html__('Widget to display your Facebook page on your website.', 'mhp')
			)
		);
	}
    function widget($args, $instance) {
    	$defaults = array('title' => esc_html__('Follow on Facebook', 'mhp'), 'fb_url' => 'https://www.facebook.com/MHthemes', 'width' => 310, 'height' => 500, 'cover' => 0, 'faces' => 1, 'posts' => 0);
    ...
    function form($instance) {
        ...
        <p>
        	<label for="<?php echo esc_attr($this->get_field_id('fb_url')); ?>"><?php esc_html_e('Facebook Page URL:', 'mhp'); ?></label>
       	...
       	<p>
	    	<label for="<?php echo esc_attr($this->get_field_id('width')); ?>"><?php esc_html_e('Width (min. 280px):', 'mhp'); ?></label>
	    ...
	    <p>
	    	<label for="<?php echo esc_attr($this->get_field_id('height')); ?>"><?php esc_html_e('Height (min. 130px):', 'mhp'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('cover')); ?>"><?php esc_html_e('Hide cover photo', 'mhp'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('faces')); ?>"><?php esc_html_e('Show profile photos', 'mhp'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('posts')); ?>"><?php esc_html_e('Show posts from FB page', 'mhp'); ?></label>
		</p><?php
    }
}
