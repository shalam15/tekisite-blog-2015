...
class mh_purity_youtube extends WP_Widget {
    function __construct() {
		parent::__construct(
			'mh_purity_youtube', esc_html_x('MH YouTube Video', 'widget name', 'mhp'),
			array(
				'classname' => 'mh_purity_youtube',
				'description' => esc_html__('Widget to display a YouTube Video.', 'mhp'),
    ...
    function form($instance) {
        ...
        <p>
        	<label for="<?php echo esc_attr($this->get_field_id('video_id')); ?>"><?php esc_html_e('Video ID:', 'mhp'); ?></label>
            ...
            <small><?php _e('Enter the YouTube video ID - also known as the watch code, example: AvOTBFM_3RQ', 'mhp'); ?></small>
        </p>
        <p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('autoplay')); ?>"><?php esc_html_e('Enable Autoplay', 'mhp'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('showinfo')); ?>"><?php esc_html_e('Display Video Title / Information', 'mhp'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('controls')); ?>"><?php esc_html_e('Display Player Controls', 'mhp'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('related')); ?>"><?php esc_html_e('Recommend Related Videos', 'mhp'); ?></label>
		</p><?php
    }
}
