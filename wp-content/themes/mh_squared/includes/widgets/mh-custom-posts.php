...
class mh_squared_custom_posts extends WP_Widget {
	function __construct() {
		parent::__construct(
			'mh_squared_custom_posts', esc_html_x('MH Custom Posts', 'widget name', 'mh-squared'),
			array(
				'classname' => 'mh_squared_custom_posts',
				'description' => esc_html__('Display posts including thumbnail images.', 'mh-squared'),
				'customize_selective_refresh' => true
			)
		);
	}
	function widget($args, $instance) {
		$defaults = array('title' => '', 'link' => '', 'category' => 0, 'cats' => '', 'tags' => '', 'postcount' => 6, 'offset' => 0, 'order' => 'date', 'sticky' => 1);
							...
							<div class="custom-posts-thumb">
								<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php
									if (has_post_thumbnail()) {
										the_post_thumbnail('mh-squared-small');
									} else {
