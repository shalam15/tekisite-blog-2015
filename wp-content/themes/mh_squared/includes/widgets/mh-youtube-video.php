...
class mh_squared_youtube_video extends WP_Widget {
    function __construct() {
		parent::__construct(
			...
			array(
				'classname' => 'mh_squared_youtube_video',
				'description' => esc_html__('Widget to display a YouTube Video.', 'mh-squared'),
    ...
    function form($instance) {
        ...
        <p>
            ...
            <small><?php _e('Enter the YouTube video ID - also known as the watch code (e.g. AvOTBFM_3RQ)', 'mh-squared'); ?></small>
        </p>
        <p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('autoplay')); ?>"><?php esc_html_e('Enable Autoplay', 'mh-squared'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('showinfo')); ?>"><?php esc_html_e('Display Video Title / Information', 'mh-squared'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('controls')); ?>"><?php esc_html_e('Display Player Controls', 'mh-squared'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('related')); ?>"><?php esc_html_e('Recommend Related Videos', 'mh-squared'); ?></label>
		</p><?php
    }
}
