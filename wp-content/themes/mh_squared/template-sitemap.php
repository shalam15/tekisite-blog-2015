...
<div class="sitemap mh-row clearfix">
	<div id="main-content" class="mh-col-2-3">
		<?php mh_squared_before_page_content(); ?>
		<article <?php post_class('post-wrapper'); ?>>
			...
			<div class="entry-content">
				<h3 class="entry-sub-title">
					<?php _e('Recent Posts', 'mh-squared'); ?>
				</h3>
				...
				<h3 class="entry-sub-title">
					<?php _e('Archives', 'mh-squared'); ?>
				</h3>
				<ul class="sitemap-list widget-list">
					<?php wp_get_archives('type=monthly&show_post_count=1'); ?>
				</ul>
				<h3 class="entry-sub-title">
					<?php _e('Categories', 'mh-squared'); ?>
				</h3>
                <ul class="sitemap-list widget-list"><?php
                	$args = array('title_li' => '', 'feed' => 'RSS', 'show_option_none' => __('No categories', 'mh-squared'));
